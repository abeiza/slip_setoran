						...
						<div class="mdl-grid">
						  <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="display:block;padding-top:20px;">
								<select id="select_slip" name="" class="mdl-textfield__input" onchange="javascript:location.href = this.value;">
									<?php
										$get_data_slip = $this->db->query("select slip.ObjectID, slip.Slip_Name_e, bank.Bank_Name from tbl_SlipSetor_Ms_Slip as slip inner join tbl_SlipSetor_Ms_Bank as bank on slip.Bank_ID = bank.ObjectID where Slip_Status = '1' order by Bank_Name, Slip_Name_e");
										foreach($get_data_slip->result() as $sl){
									?>
										<option value="<?php echo base_url();?>index.php/form_slip/form/<?php echo $sl->ObjectID;?>" <?php echo $sl->ObjectID == $this->uri->segment(3)?"selected":"";?>><?php echo "(".$sl->Bank_Name.")  ".$sl->Slip_Name_e;?></option>
									<?php
										}
									?>
								</select>
								...
								<div>
									<?php 
										...
										echo form_open('form_slip/add_transaction/'.$this->uri->segment(3),$attribute);
									?>
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<input type="checkbox" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											...
											<input class="mdl-textfield__input tanggal_digit" maxlength="1" style="margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php					
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											...
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input nominal" style="float:left;width:350px;margin-left:0px;margin-top:1px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input total" style="float:left;width:350px;margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input nominal" style="margin-left:0px;margin-top:1px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input total" style="margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input" style="float:left;width:150px;margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input" style="float:left;width:350px;margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
													}else{
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input onchange="numberFormat(<?php echo $fm->Slip_Field;?>);" class="mdl-textfield__input" style="margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
													}
												}else{
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" style="margin-left:5px;float:left;width:150px;margin-right:5px;font-size:15px;background:#f6f6f6;color:#000;padding:10px;border:none;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}else if($fm->Slip_Var_Group == 'inline_long'){
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" style="margin-left:5px;float:left;width:350px;margin-right:5px;font-size:15px;background:#f6f6f6;color:#000;padding:10px;border:none;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}else{
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" style="font-size:15px;background:#f6f6f6;color:#000;padding:10px;border:none;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}	
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" style="float:left;width:150px;margin-left:5px;" type="text" disable id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}else if($fm->Slip_Var_Group == 'inline_long'){
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left;" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" style="float:left;width:350px;margin-left:5px;" type="text" disable id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}else{
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<input class="mdl-textfield__input" type="text" disable id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}
									...
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											...
											<input class="mdl-textfield__input" style="float:left;width:150px;margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}else if($fm->Slip_Var_Group == 'inline_long'){
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											<label style="font-size:12px;color:#46B6AC;float:left" for="sample3"><?php echo $fm->Slip_Var_Name;?></label>
											<i class="mdl-color-text--blue-grey-400 material-icons" role="presentation" style="font-size:18px;float:left;" id="search_cust" onclick="show_list_cust(<?php echo substr($fm->Slip_Field,16,2);?>)">search</i>
											<input class="mdl-textfield__input" style="float:left;width:350px;margin-left:5px;" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php 
														}else{
									?>
										<div style="<?php echo $fm->Slip_Var_Css;?>">
											...
											<input class="mdl-textfield__input" type="text" id="<?php echo $fm->Slip_Field;?>" name="<?php echo $fm->Slip_Field;?>">
										</div>
									<?php
														}
